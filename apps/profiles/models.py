...
class Profile(TimeStampedUUIDModel):
	...
	phone_number = PhoneNumberField(verbose_name=_("Phone Number"), unique=True, max_length=30, default="+63919043384")
	...
	country = CountryField(verbose_name=_("Country"), default="PH", blank=False, null=False )
	...
	is_agent = models.BooleanField(verbose_name=_("Agent"), default=False, help_text = _("Are you looking an agent?"))
